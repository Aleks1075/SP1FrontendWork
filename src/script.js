...
async function getAllCityInfo() {
    ...
    const apiUrl = 'https://aleksdat.dk/sp1/api/cityinfo/danish-zip-codes';
...
async function getCityInfoByZipCode() {
    ...
    const apiUrl = `https://aleksdat.dk/sp1/api/cityinfo/${zipCode}`;
    const data = await fetchData(apiUrl);
...
async function getAllPersons() {
    ...
    const apiUrl = 'https://aleksdat.dk/sp1/api/person';
    const data = await fetchData(apiUrl);
...
async function getPersonById() {
    ...
    const apiUrl = `https://aleksdat.dk/sp1/api/person/${id}`;
    const data = await fetchData(apiUrl);
...
async function getAllHobbies() {
    ...
    const apiUrl = 'https://aleksdat.dk/sp1/api/hobby';
    const data = await fetchData(apiUrl);
    console.log(data);
...
async function getPersonsByHobby() {
    ...
    const apiUrl = `https://aleksdat.dk/sp1/api/person/hobby/${hobbyName}`;
...
async function getPersonByPhoneNumber() {
    ...
    const apiUrl = `https://aleksdat.dk/sp1/api/person/phone/${phoneNumber}`;
    const data = await fetchData(apiUrl);
...
async function getPersonsByCity() {
    ...
    const apiUrl = `https://aleksdat.dk/sp1/api/person/zipCode/${zipCode}`;
    const data = await fetchData(apiUrl);
...
async function getHobbyCount() {
    ...
    const apiUrl = `https://aleksdat.dk/sp1/api/person/personByHobby/${hobbyName}`;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  form.addEventListener("submit", async function (event) {
    ...
    try {
      const response = await fetch("https://aleksdat.dk/sp1/api/person/add", {
        method: "POST",
        headers: {
...
deleteBtn.addEventListener("click", async function (event) {
    ...
    try {
        const response = await fetch(`https://aleksdat.dk/sp1/api/person/${personId}`, {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json",
            },
